...
class ProjectExporter:
    ...
    def _export_pdf(self) -> HttpResponse:
        ...
        elements.append(Paragraph(f"{self.project.name} — Task Export", styles["Title"]))
        elements.append(Paragraph(
            f"Generated by {self.user.full_name} on {date.today().isoformat()} "
