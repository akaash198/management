export const colors = {
  ...
  gradPrimary: ["#DAB241", "#B88B10"] as string[],
  gradPrimaryVivid: ["#E6C56A", "#C9A227", "#7DD3FC"] as string[],
  gradSurface: ["#121B2D", "#0E1524"] as string[],
  gradHero: ["#121B2D", "#0B1220", "#060810"] as string[],
  gradWarm: ["#38BDF8", "#60A5FA"] as string[],
  gradCard: ["#18233A", "#0E1524"] as string[],
  gradAI: ["#7C3AED", "#4F46E5"] as string[],
  gradDanger: ["#EF4444", "#DC2626"] as string[],

  glassWhite: "rgba(255, 255, 255, 0.06)",
  glassDark: "rgba(0, 0, 0, 0.42)",
  glassBorder: "rgba(255, 255, 255, 0.12)",
  glassBorderDark: "rgba(255, 255, 255, 0.08)",
  glassBorderActive: "rgba(201, 162, 39, 0.38)",
